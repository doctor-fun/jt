...
/**
 * 定义连接池（通过连接池管理器定义）
 * 创建builder对象（生成构造者，将连接池的详细信息交给他）
 * 每次利用builder实例化一个CloseableHttpClient,构造会考虑池的实际情况看是否需要生成生产一个新的还是去取
 */
/**
 * @author fangchen
 * @date 2020/1/22 1:58 上午
 */
@Configuration
...
//-----------------------------
	...
	/**
	 * 使用builder构建一个RequestConfig对象，用于定义httpclient请求的配置信息，如connectTimeout，connectionRequestTimeout等
	 * 	 * @param builder
	 * @return
	 */
	@Bean
